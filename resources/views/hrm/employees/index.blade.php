        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody class="small text-dark">
                    ...
                    @empty
                    <tr><td colspan="6" class="text-center py-5 text-muted font-monospace">No systemic employee entities registered.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select form-select-sm rounded-2 @error('role') is-invalid @enderror" id="role" name="role" required>
                                ...
                                <option value="Manager" {{ old('role') === 'Manager' ? 'selected' : '' }}>Manager (Departmental Control)</option>
                                <option value="Employee" {{ old('role') === 'Employee' ? 'selected' : '' }}>Standard Employee (Read/Self)</option>
                            </select>
